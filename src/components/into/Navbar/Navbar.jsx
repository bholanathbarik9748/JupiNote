          ...
          <header className="text-white body-font text-2xl">
              <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                  ...
                  <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                      <Link className="mr-5 text-black hover:text-amber-700" style={{cursor:"pointer"}}>About us</Link>
                      <Link className="mr-5 text-black hover:text-amber-700" style={{ cursor: "pointer"}}>Help</Link>
